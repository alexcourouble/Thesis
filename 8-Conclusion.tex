...
Email2git, our code reivew tracking system, has a few important limitations. The first limitation to consider is the missing mailing list. Although our patch data source, patchwork.kernel.org, already track many precious mailing lists, some major mailings list like \tetxtt{net-dev} are not tracked. This is reflected in the low number of commit matched in the \textt{net} subdirectory. 
