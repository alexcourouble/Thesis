...
As an answer to the risks associated with employee turn over in software engineering organizations, researchers have attempted to establish models capable of finding experts in certain code areas. By recommending experienced developers, these models would ease the difficulty of replacing current experts as they leave the organization. \alex{citations and concrete numbers}


Introduced in the early 2000s, these models were using two simple metrics to assess expertise: number of \ac{LOC} and number of commits. \alex{why these? need more details}
