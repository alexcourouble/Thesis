...
\alex{Talk about performance of each step}
...
\alex{Total performance, show graph with matched commits}


\alex{Show web requests plots to show performance of email2git}
